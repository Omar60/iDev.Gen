...
export const SHOOT_LINE_INSTRUCTION =
  ...
  + 'So a framing tighter than full-length is written by NOT naming what falls outside it: '
  + 'a waist-up photograph of a pose that mentions her knees is a photograph of her knees. '
  ...
  + 'So the walk of the whole body and a framing tighter than full-length cannot both be '
  + 'had in one photograph. The wardrobe wins that fight, because the garments are what '
  + 'the next photograph copies and a line that drops them drops them for every line '
  + 'after it. A line still wearing anything below the waist is a full-length photograph, '
  + 'and the tighter framings are for the lines whose remaining wardrobe is above it.\n'
