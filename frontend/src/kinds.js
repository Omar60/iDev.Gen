...
export const SHOOT_LINE_INSTRUCTION =
  'Write one line per photograph of a photo session. Each line is a whole photograph: what '
  + 'she is wearing at that moment, what her body is doing, and her expression — in that '
  + 'order, as prose, one line each, in the order they are shot.\n'
  + PROSE + '\n'
  + 'Sixty words a line is the ceiling and it is a hard one — long enough for the state of '
  + 'the wardrobe, the pose and the face, and no longer. Measured on this model, a wardrobe '
  + 'written past that point came back as a different garment several frames in. Naming a '
  + 'garment again in the same line, or re-listing what the line already said, is where '
  + 'those words go: say each piece once.\n'
...
export const shootChunkNote = (at) =>
  ...
  + (at.previous
    ...
    : 'The wardrobe below is what she is wearing in photograph 1, and your first line dresses '
      + 'her in it exactly as given — only the pose and the expression are yours to write '
      + 'there.')
