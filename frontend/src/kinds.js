...
export const SHOOT_LINE_INSTRUCTION =
  ...
  + PROSE + '\n'
  + '\n'
  + 'THE `camera` FIELD IS WHERE THE CAMERA IS, AND THEN ITS FRAMING, IN THAT ORDER. The '
  + 'position is handed to you on the row of each photograph, like the framing below it: '
  + 'copy the position word for word and write the framing after it. It is the first '
