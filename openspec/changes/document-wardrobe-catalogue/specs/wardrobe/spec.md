...
order: N garments SHALL produce N+1 states, one garment leaving at each step,
and the last state SHALL be bare.
...
- **WHEN** the arc of an outfit of three garments is derived
